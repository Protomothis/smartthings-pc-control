...
var messages = map[string]map[Lang]string{
	...
	"st.wol":               {LangKo: "WoL 어댑터", LangEn: "WoL adapter"},
	"st.wol.auto":          {LangKo: "자동 (%s · %s)", LangEn: "Automatic (%s · %s)"},
	"st.wol.auto.none":     {LangKo: "자동 (어댑터 없음)", LangEn: "Automatic (no adapter found)"},
	"st.wol.adapter":       {LangKo: "%s · %s · %s", LangEn: "%s · %s · %s"},
	"st.wol.on":            {LangKo: "WoL 켜짐", LangEn: "WoL on"},
	"st.wol.off":           {LangKo: "WoL 꺼짐", LangEn: "WoL off"},
	"st.wol.na":            {LangKo: "WoL 미지원", LangEn: "WoL not supported"},
	"st.wol.missing":       {LangKo: "없는 어댑터 · %s", LangEn: "Adapter not found · %s"},
	"st.wol.hint":          {LangKo: "허브가 이 PC를 깨울 때 쓸 어댑터입니다. 자동은 허브의 요청이 실제로 들어오는 어댑터를 먼저 고릅니다.", LangEn: "The adapter the hub wakes this PC through. Automatic prefers the one the hub's requests actually arrive on."},
	"st.wol.loading":       {LangKo: "어댑터 목록 확인 중...", LangEn: "Checking adapters..."},
	"st.wol.ready":         {LangKo: "%s에서 WoL이 켜져 있습니다", LangEn: "WoL is on for %s"},
	"st.wol.notready":      {LangKo: "%s에서 WoL이 꺼져 있습니다 — 어댑터 전원 관리 설정에서 켜 주세요", LangEn: "WoL is off on %s — turn it on in the adapter's power management settings"},
	"st.wol.unsupported":   {LangKo: "%s은(는) WoL을 지원하지 않습니다 — 다른 어댑터를 고르거나 BIOS 설정을 확인하세요", LangEn: "%s does not support WoL — pick another adapter or check the BIOS settings"},
	"st.wol.none":          {LangKo: "WoL에 쓸 수 있는 어댑터가 없습니다", LangEn: "No adapter this PC could be woken through"},
