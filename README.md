...
- **화면 켜기/끄기 자식 장치**와 자동화용 명령(`pcCommand.execute`, `pcSchedule.schedule` / `cancel`).
...
- **A screen on/off child device**, plus automation commands (`pcCommand.execute`, `pcSchedule.schedule` / `cancel`).
