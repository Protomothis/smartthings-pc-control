...
function T.test_an_older_profile_migrates_to_the_current_one()
  h.assert_equal(profiles.migration_for("pc.v1"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v2"), "pc.v13")
end

function T.test_the_current_profile_does_not_migrate()
  h.assert_equal(profiles.migration_for("pc.v3"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v4"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v5"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v6"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v7"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v8"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v9"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v10"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v11"), "pc.v13")
  h.assert_equal(profiles.migration_for("pc.v12"), "pc.v13")
  h.assert_nil(profiles.migration_for("pc.v13"))
end
